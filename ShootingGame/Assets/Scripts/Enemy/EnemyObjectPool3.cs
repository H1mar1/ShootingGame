...
public class EnemyObjectPool3 : MonoBehaviour
{
    //シングルトン
    ...
    private Enemy enemy3Prefab;

    // Enemy を生成・管理・再利用するためのプール
    private ObjectPool<Enemy> enemyPool3;
    ...
    private void Awake()
    {
        ...
        enemyPool3 = new ObjectPool<Enemy>(
    ...
    private Enemy CreateEnemy()
    {
        ...
        return Instantiate(enemy3Prefab, transform);
    }
    ...
    private void OnGetEnemy(Enemy enemy)
    {
        ...
        enemy.Initialize(() => enemyPool3.Release(enemy));
        // 出現位置をランダムに設定（画面上部）
    ...
    public int ActionCount => enemyPool3.CountActive;
}
