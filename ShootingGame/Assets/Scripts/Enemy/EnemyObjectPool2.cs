...
public class EnemyObjectPool2 : MonoBehaviour
{
    ...
    private Enemy enemy2Prefab;

    // Enemy を生成・管理・再利用するためのプール
    private ObjectPool<Enemy> enemyPool2;
    ...
    private void OnGetEnemy(Enemy enemy)
    {
        ...
        enemy.Initialize(() => enemyPool2.Release(enemy));
        // 出現位置をランダムに設定（画面上部）
    ...
    public int ActionCount => enemyPool2.CountActive;
}
